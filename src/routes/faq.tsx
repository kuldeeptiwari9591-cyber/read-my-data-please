...
const GROUPS: Group[] = [
  {
    ...
    faqs: [
      ...
      { q: "How does CrispPDF stay free?", a: "It's currently funded out of pocket by the founders. Future revenue may come from an optional developer API and a self-hosted enterprise version. The free consumer tools at crisppdf.in will always remain free with no feature paywalls." },
  ...
  },
  {
    ...
    faqs: [
      ...
      { q: "Can I use CrispPDF on a Chromebook?", a: "Yes. CrispPDF works perfectly on Chromebooks — open Chrome, navigate to crisppdf.in, and use any tool. There is no app to install. Processing uses the Chromebook's CPU, so older models may be slower with large files. Linux/Android Chromebook apps are not needed." },
